package com.example.improvesocket;
/*********************
 * Socket Server
 * @file Server.java
 * @author Mohamed MIHOUBI
 **********************/
...
public class ImprovementServer extends Thread {
    private ServerSocket serverSocket;
    private static int port = 6500;

    public ImprovementServer() throws IOException {
    ...
    public static void main(String [] args) {
        ...
        try {
            ...
            Thread t = new ImprovementServer();
            t.start();
        } catch (IOException e) {
            e.printStackTrace();
        }
